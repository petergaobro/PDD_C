...
/**
 * The maximum length of a product name string
 **/
#define NAMELEN 40

/**
 * The maximum length of a product description string
 * terminator.
 **/
#define DESCLEN 255

/**
 * The maximum length of a price string
 **/
#define PRICELEN 5

/**
 * The maximum length of onhand items string
 **/
#define ONHAND_LEN 2

/**
 * The maximum onhand value string
 **/
#define MAX_ONHAND 99

/**
 * The number of separators in a valid line of the stock file
 **/
#define SEPARATORS 4

/**
 * The number of digits dedicated to representing the cents in a string
 **/
#define CENTS_LEN 2

/**
 * The total maximum line length of a line in the stock file
 **/
#define STOCK_LEN IDLEN + NAMELEN + DESCLEN + PRICELEN + ONHAND_LEN + \
    SEPARATORS
...
void display_stock(struct ppd_list*);

struct ppd_stock * frindStockById(char * itemId,struct ppd_system * system);
